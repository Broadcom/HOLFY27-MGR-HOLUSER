#!/usr/bin/env python3
# prelim.py - VXP LabType Custom Override Module
# Version 1.0 - January 2026
# Author - HOL Core Team
# 
# This is a custom override prelim.py for VXP (VCF Experience Program) labs.
...
#   2. /home/holuser/hol/Startup.VXP/prelim.py     (This file - VXP labtype override)
...
MODULE_NAME = 'prelim'
MODULE_DESCRIPTION = 'VXP LabType Preliminary Tasks (Custom Override)'
LABTYPE = 'VXP'
...
def main(lsf=None, standalone=False, dry_run=False):
    ...
    ##=========================================================================
    ## VXP LabType Custom Override - prelim.py
    ##=========================================================================
    ...
    try:
        ...
        dashboard.update_task('prelim', 'vxp_custom', 'running')
    ...
    ## CUSTOM CODE SECTION
    ##
    ## Add your VXP-specific preliminary tasks here.
    ## These will run INSTEAD of the default Startup/prelim.py tasks.
    ##
    ## VXP labs have firewall AND proxy filtering enabled (like HOL).
    ##
    ...
    # Example: Log VXP-specific information
    lsf.write_output(f'VXP Lab SKU: {lsf.lab_sku}')
    lsf.write_output(f'VXP (VCF Experience Program) labs have full security features')
    lsf.write_output(f'VXP labs are demo environments for VCF Experience')
    
    ##=========================================================================
    ## CUSTOM - Insert your VXP-specific code here
    ##=========================================================================
    ...
    if dashboard:
        dashboard.update_task('prelim', 'vxp_custom', 'complete')
        dashboard.generate_html()
