...
class LabDetailsGenerator:
    ...
    def generate_html(self, svg_map: Dict[str, str]) -> str:
        ...
        html.append('          <tr><td><strong>Generated By</strong></td><td><code>python3 Tools/generate_labdetails.py --html --output /lmchol/home/holuser/diagrams/{sku}-labdetails.md</code></td></tr>')
