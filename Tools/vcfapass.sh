...
spawn ssh vmware-system-user@$host
expect "(vmware-system-user@$host) Password:"
send "$old_password\r"
expect "You are required to change your password immediately (administrator enforced)."
expect "Current password:"
send "$old_password\r"
expect "(vmware-system-user@$host) New password:"
send "$new_password\r"
expect "(vmware-system-user@$host) Retype new password:"
send "$new_password\r"
