#!/usr/bin/env python3
# prelim.py - HOLFY27 DISCOVERY Preliminary Tasks Override
# Version 3.11-DISCOVERY1 - 2026-05-28
...
def main(lsf=None, standalone=False, dry_run=False):
    ...
    if loader.requires_firewall():
        ...
        # DISCOVERY override: belt-and-suspenders re-push of nofirewall.sh.
    ...
    if loader.requires_proxy_filter():
        ...
        # DISCOVERY override: confirm empty proxy values are in effect.
    ...
    # DISCOVERY override: when proxy is not required, actively clear any stale
