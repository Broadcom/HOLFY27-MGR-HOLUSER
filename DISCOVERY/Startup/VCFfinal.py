#!/usr/bin/env python3
# VCFfinal.py - HOLFY27 DISCOVERY VCF Final Tasks Override
# Version 6.3.12-DISCOVERY1 - 2026-05-28
# Author - Burke Azbill and HOL Core Team
# VCF final tasks (Tanzu, VCF Automation)
#
# DISCOVERY override changes (relative to core Startup/VCFfinal.py):
            ...
            if not wcp_active_vcenters:
                ...
                try:
                    ...
                    if not _proxy_required:
                        ...
                        # DISCOVERY override: run Phase 0 and Phase 2 with empty
                        ...
                        lsf.write_output(
                            'DISCOVERY: proxy not required — running supervisor_stabilizer '
                    ...
                    # DISCOVERY override: Target 3 — clear Supervisor API cluster_proxy_config.
                    # Runs after the stabilizer subprocess so the Supervisor is reachable.
                    if not _proxy_required:
                        lsf.write_output('DISCOVERY: Clearing Supervisor API proxy config (Target 3)...')
                        try:
                            ...
                            lsf.write_output(f'DISCOVERY: Supervisor API proxy clear skipped: {_t3_err}')
...
'''
                ...
                if vsp_node_ips:
                    ...
                    if _proxy_required:
                        ...
                        # DISCOVERY override: Target 4 — clear proxy on each VSP node.
                        lsf.write_output(f'DISCOVERY: Clearing proxy on {len(vsp_node_ips)} VSP node(s) (Target 4)...')
                        ...
                        if not provisioning_vms:
                            ...
                            if new_ips:
                                ...
                                if _proxy_required:
                                    ...
                                    # DISCOVERY override: clear proxy on newly-joined VSP nodes.
                                    lsf.write_output(f'DISCOVERY: Clearing proxy on {len(new_ips)} new VSP node(s) (Target 4)...')
