#!/usr/bin/env python3
# prelim.py - ATE LabType Preliminary Tasks Module
# Version 3.0 - January 2026
# Author - Burke Azbill and HOL Core Team
# 
# This is the ATE labtype prelim.py which includes all core functionality
# plus ATE-specific customizations.
#
...
MODULE_NAME = 'prelim'
MODULE_DESCRIPTION = 'ATE LabType Preliminary Tasks'
LABTYPE = 'ATE'
...
def main(lsf=None, standalone=False, dry_run=False):
    ...
    ##=========================================================================
    ## CUSTOM - ATE LabType Specific Code
    ## 
    ## ATE (Advanced Technical Enablement) labs have:
    ## - Firewall enabled
    ## - NO proxy filtering
    ##
    ## Add your ATE-specific customizations below.
    ##=========================================================================
