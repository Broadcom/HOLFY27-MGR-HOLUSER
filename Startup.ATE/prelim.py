#!/usr/bin/env python3
# prelim.py - ATE LabType Custom Override Module
# Version 1.0 - January 2026
# Author - HOL Core Team
# 
# This is a custom override prelim.py for ATE (Advanced Technical Enablement) labs.
...
#   2. /home/holuser/hol/Startup.ATE/prelim.py     (This file - ATE labtype override)
...
MODULE_NAME = 'prelim'
MODULE_DESCRIPTION = 'ATE LabType Preliminary Tasks (Custom Override)'
LABTYPE = 'ATE'
...
def main(lsf=None, standalone=False, dry_run=False):
    """
    Main entry point for ATE prelim module
    ...
    ##=========================================================================
    ## ATE LabType Custom Override - prelim.py
    ##=========================================================================
    ...
    try:
        ...
        dashboard.update_task('prelim', 'ate_custom', 'running')
    ...
    ## CUSTOM CODE SECTION
    ##
    ## Add your ATE-specific preliminary tasks here.
    ...
    # Example: Log ATE-specific information
    lsf.write_output(f'ATE Lab SKU: {lsf.lab_sku}')
    lsf.write_output(f'ATE labs have firewall enabled but no proxy filtering')
    
    ##=========================================================================
    ## CUSTOM - Insert your ATE-specific code here
    ##=========================================================================
    ...
    ## ----------------------------------------------------
    # lsf.labfail('ATE PRELIM ISSUE - Critical check failed')
    # exit(1)
    ...
    if dashboard:
        dashboard.update_task('prelim', 'ate_custom', 'complete')
        dashboard.generate_html()
